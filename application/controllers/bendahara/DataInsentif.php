...
class DataInsentif extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('bendahara/Insentif/dataInsentif', $data);
  ...
  public function tambahData()
  {
    ...
    $this->load->view('templates_bendahara/header', $data);
    $this->load->view('templates_bendahara/sidebar');
    $this->load->view('bendahara/Insentif/tambahDataInsentif', $data);
    $this->load->view('templates_bendahara/footer');
  }
  ...
  public function tambahDataAksi()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      redirect('bendahara/dataInsentif');
    }
  }
  ...
  public function updateData($id)
  {
    ...
    $this->load->view('templates_bendahara/header', $data);
    $this->load->view('templates_bendahara/sidebar');
    $this->load->view('bendahara/Insentif/updateDataInsentif', $data);
    $this->load->view('templates_bendahara/footer');
  }
  ...
  public function printData()
  {
    ...
    $data['insentif'] = $this->penggajianModel->get_data('data_insentif')->result();
    $this->load->view('templates_bendahara/header', $data);
    $this->load->view('bendahara/Insentif/cetakdatainsentif');
  }
