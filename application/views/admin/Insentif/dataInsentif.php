...
<div class="container-fluid">
  ...
  <a class="btn btn-sm btn-success mb-3" href="<?= base_url('admin/dataInsentif/tambahData/'); ?>"><i class="fas fa-plus"></i> Tambah Data</a>
  <a class="btn btn-sm btn-danger mb-3" target="blank" href="<?= base_url('admin/dataInsentif/printData/'); ?>"><i class="fas fa-print"></i> Print Data</a>
  ...
  <table class="table table-bordered table-stiped mt-2">
    ...
    foreach ($insentif as $j) : ?>
      <tr>
        ...
        <td>
          <center>
            <a class="btn btn-sm btn-primary" href="<?= base_url('admin/dataInsentif/updateData/' . $j->id_insentif); ?>"><i class="fas fa-edit"></i></a>
            <a onclick="return confirm('Yakin hapus?')" class="btn btn-sm btn-danger" href="<?= base_url('admin/dataInsentif/deleteData/' . $j->id_insentif); ?>"><i class="fas fa-trash"></i></a>
          </center>
        </td>
      </tr>
    <?php endforeach; ?>
