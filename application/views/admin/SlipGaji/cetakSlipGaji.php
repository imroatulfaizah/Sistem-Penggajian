...
<head>
  ...
  <style>
    ...
    .amount { text-align: right; font-weight: 600; color: #2d3748; }
    .detail { font-size: 0.9em; color: #718096; display: block; margin-top: 4px; }
    .highlight {
...
<div class="container">
  ...
  <div class="content">
    <?php
    $s = $slip;
    $jam_mengajar = $s->total_jam_mengajar ?? 0;
    ...
    <table class="salary-table">
      ...
      <tbody>
        ...
        <tr class="highlight">
          <td colspan="2" class="text-right" style="font-size:1.2em; font-weight:bold;">TOTAL GAJI</td>
          <td class="amount" style="font-size:1.5em; color:#1a202c; font-weight:bold;">
