  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <form class="form-inline">
        ...
        <?php if (count($gaji) > 0) { ?>
          <a href="<?= base_url('bendahara/dataPenggajian/cetakGaji?bulan=' . $bulan), '&tahun=' . $tahun; ?>" class="btn btn-success mb-2 ml-3" target="blank"><i class="fas fa-print"></i> Cetak Daftar Gaji</a>
        <?php
        } else { ?>
