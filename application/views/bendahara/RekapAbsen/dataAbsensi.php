  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <form class="form-inline">
        ...
        <a href="<?= base_url('bendahara/dataAbsensi/inputAbsensi'); ?>" class="btn btn-success mb-2 ml-3"><i class="fas fa-plus"></i> Input Kehadiran</a>
      </form>
    </div>
  </div>
    ...
    <table class="table table-bordered table-striped">
      ...
      foreach ($absensi as $a) : ?>
        <tr>
          ...
          <td>
            <center>
              <!--<a class="btn btn-sm btn-primary" href="<?= base_url('bendahara/dataAbsensi/updateData/' . $a->id_kehadiran); ?>"><i class="fas fa-edit"></i></a>-->
              <a onclick="return confirm('Yakin hapus?')" class="btn btn-sm btn-danger" href="<?= base_url('bendahara/dataAbsensi/deleteData/' . $a->id_kehadiran); ?>"><i class="fas fa-trash"></i></a>
            </center>
          </td>
        </tr>
      <?php endforeach; ?>
