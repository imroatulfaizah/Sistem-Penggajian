    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('bendahara/dataAbsensi'); ?>">Rekap Data Absensi</a>
            <a class="collapse-item" href="<?= base_url('bendahara/dataInsentif'); ?>">Rekap Data Insentif</a>
            <a class="collapse-item" href="<?= base_url('bendahara/dataPenggajian'); ?>">Data Gaji</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('bendahara/laporanGaji'); ?>">Laporan Gaji</a>
            <a class="collapse-item" href="<?= base_url('bendahara/laporanAbsensi'); ?>">Laporan Absensi</a>
