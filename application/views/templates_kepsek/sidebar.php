    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('kepsek/dataAbsensi'); ?>">Rekap Data Absensi</a>
            <a class="collapse-item" href="<?= base_url('kepsek/dataInsentif'); ?>">Rekap Data Insentif</a>
            <a class="collapse-item" href="<?= base_url('kepsek/dataPenggajian'); ?>">Data Gaji</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Pages Collapse Menu -->
      <!-- <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?= base_url('kepsek/laporanGaji'); ?>">Laporan Gaji</a>
            <a class="collapse-item" href="<?= base_url('kepsek/laporanAbsensi'); ?>">Laporan Absensi</a>
            <a class="collapse-item" href="<?= base_url('kepsek/slipGaji'); ?>">Slip Gaji</a>
          </div>
        </div>
      </li> -->
      <li class="nav-item active">
        <a class="nav-link" href="<?= base_url('kepsek/GantiPassword'); ?>">
